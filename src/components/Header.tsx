...
export function Header({ tasksCounter }: HeaderProps) {
  ...
  function implementTaskCounter(tarefas: Number) {
    let countTarefas
    if (tarefas === 1) {
      return countTarefas = 'tarefa'
    } else {
      return countTarefas = 'tarefas'
    }

  }

  const tasksCounterText = implementTaskCounter(tasksCounter)
